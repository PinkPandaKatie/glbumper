...
int main (int argc, char **argv) {
    ...
    //sptr<ServerThread> svr = new ServerThread(framems);
	...
	//sptr<SMDPLoopbackConnection> conn1 = new SMDPLoopbackConnection();
	//sptr<SMDPLoopbackConnection> conn2 = conn1->getpeer();

	//svr->connect_loopback(conn1);
	gcomp->connect(hostname);//_loopback(conn2);
